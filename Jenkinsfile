          ...
          stage('Build Common Package') {
            steps {
              container('rpmdev-fedora') {
                ...
                sh 'echo "" | setsid rpmbuild -bb --sign --define \'_byondmajor 512\' --define \'_byondminor 1488\' --define \'_releaseversion 1\' --target i386 specs/byond-common.spec'
          ...
          stage('Build DreamMaker Package') {
            steps {
              container('rpmdev-fedora') {
                ...
                sh 'rpmdev-setuptree'
                sh 'cp /data/upstream/stable/512.1488/512.1488_byond_linux.zip ~/rpmbuild/SOURCES/'
                sh 'echo "" | setsid rpmbuild -bb --sign --define \'_byondmajor 512\' --define \'_byondminor 1488\' --define \'_releaseversion 1\' --target i386 specs/byond-dreammaker.spec'
                sh "mkdir -p /data/fedora/${RELEASE}/base/i386/Packages"
          ...
          stage('Build DreamDaemon Package') {
            steps {
              container('rpmdev-fedora') {
                ...
                sh 'rpmdev-setuptree'
                sh 'cp /data/upstream/stable/512.1488/512.1488_byond_linux.zip ~/rpmbuild/SOURCES/'
                sh 'echo "" | setsid rpmbuild -bb --sign --define \'_byondmajor 512\' --define \'_byondminor 1488\' --define \'_releaseversion 1\' --target i386 specs/byond-dreamdaemon.spec'
                sh "mkdir -p /data/fedora/${RELEASE}/base/i386/Packages"
