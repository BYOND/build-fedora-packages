          ...
          stage('Build Common Package') {
            steps {
              container('rpmdev-fedora') {
                ...
                sh "mkdir -p /packages/${RELEASE}/arch/i386/Packages"
                sh "cp ~/rpmbuild/RPMS/i386/byond-common-512.1488-1.i386.rpm /packages/${RELEASE}/arch/i386/Packages/"
              }
            }
          }
          ...
          stage('Build DreamMaker Package') {
            steps {
              container('rpmdev-fedora') {
                ...
                sh "mkdir -p /packages/${RELEASE}/arch/i386/Packages"
                sh "cp ~/rpmbuild/RPMS/i386/byond-dreammaker-512.1488-1.i386.rpm /packages/${RELEASE}/arch/i386/Packages/"
              }
            }
          }
        }
